                    ...
                    <div class="container p-5">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method= "GET" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="store_product_name" class="form-select" aria-label="Default select example">
                                    <?php  
                            ...
                            <div class="mb-3">
                               ...
                               <input type="text" name="store_product_quentity" class="form-control" value="<?php echo $store_product_quentity; ?>">
                            </div>

                            <div class="mb-3">
                               <label for="exampleFormControlInput1" class="form-label">Store entry date </label>
                               <input type="date" name="store_product_entry_date" class="form-control" value="<?php echo $store_product_entry_date; ?>">
                            </div>
