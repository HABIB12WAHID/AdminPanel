<h5 class="bg-success text-white px-2 py-1">User and Report</h5>
                    <ul class="list-group m-1">
                        <li class="list-group-item">
                            <a href="add_users.php" class="text-dark text-decoration-none">Sign Up</a>
                        </li>
                        <li class="list-group-item">
                            <a href="list_of_users.php" class="text-dark text-decoration-none">List of User</a>
                        </li>
                        <li class="list-group-item">
